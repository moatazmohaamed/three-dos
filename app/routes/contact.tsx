    ...
    <div className="bg-black">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 py-32 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mt-6 animate-fade-in [animation-delay:0.2s] [animation-fill-mode:backwards]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              {/* Email */}
              <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/10 hover:border-indigo-500/50 transition-colors">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:contact@threedos.org"
              ...
              {/* Linktree */}
              <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/10 hover:border-purple-500/50 transition-colors">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-lg text-purple-400 hover:text-purple-300 transition-colors inline-flex items-center gap-2"
                    >
                      linktr.ee/threedos
                      <svg
                        className="w-4 h-4"
              ...
              {/* Location */}
              <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/10 hover:border-cyan-500/50 transition-colors">
                <div className="flex items-start gap-4">
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-cyan-500 to-teal-500 flex items-center justify-center flex-shrink-0">
                    <svg
                      className="w-7 h-7 text-white"
                      fill="none"
                      stroke="currentColor"
            ...
            {/* Right Column - Map */}
            <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-4 border border-white/10 overflow-hidden h-[600px]">
              <iframe
